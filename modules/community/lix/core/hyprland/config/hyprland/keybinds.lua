...
-- Lunatix additions: nexus + dashboard shortcuts (caelestia GlobalShortcuts)
create_bind(vars.kbNexus, hl.dsp.global("caelestia:nexus"))
...
create_bind(vars.kbEmacsClient, hl.dsp.exec_cmd("emacsclient -c -a \"\""))
