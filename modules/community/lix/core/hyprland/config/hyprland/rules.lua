...
---------------------
---- Lunatix: semantic workspace routing ----
-- Apps auto-open on their category workspace (Prime-style muscle memory):
-- editors/notes -> 1, media/browser -> 2, terminal/ai -> 3.
---------------------
hl.window_rule({ match = { class = '(^nvim)' }, workspace = 1 })
hl.window_rule({ match = { class = '(^thunar)' }, workspace = 3 })
hl.window_rule({ match = { class = '(^md.Obsidian)' }, workspace = 3 })
hl.window_rule({ match = { class = '(^zen-twilight)' }, workspace = 2 })
