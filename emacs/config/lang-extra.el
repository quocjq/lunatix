...
(after! lsp-mode
  (setq lsp-idle-delay 0.5
        ...
        ;; lsp resets this to its default (user-emacs-directory/.cache, a dir)
        ;; on load; point it at a real file in our cache.
        lsp-session-file (expand-file-name "lsp-session-v1" lunaris-cache-dir))
  (make-directory (file-name-directory lsp-session-file) t))
(after! lsp-ui
